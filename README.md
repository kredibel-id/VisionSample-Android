...
After getting API-Key then open your **AndroidManifest.xml** than add a this tag in the scope of the application tag. Please name the attribute name with `io.kredibel.sdk.APIKEY`.   
